...
2. Refactor the function to take a second parameter "word" - if the 
parameter
 is not provided then it should default to 'Lorem'
...
var findMessages = function(messages,length = 'Lorem'){
    result = messages.find(function(message){
        return message.text.match(WORD_TO_FIND,'Lorem');
